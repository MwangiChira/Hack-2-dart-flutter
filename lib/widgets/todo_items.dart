    ...
    return Container(
      ...
      child: ListTile(
        ...
        tileColor: Color.fromARGB(
            235, 238, 237, 241), // Set background color of the ListTile
        leading: Icon(
          todo.isDone
              ? Icons.check_box
              : Icons
                  .check_box_outline_blank, // Display check box icon based on completion status
          color: Color.fromARGB(192, 3, 63, 153), // Set icon color to blue
        ),
        title: Text(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color: Color.fromARGB(218, 235, 6,
                6), // Set background color of the delete button container to red
          ...
          child: IconButton(
            ...
            icon: Icon(
              ...
              size: 18,
              color:
                  Color.fromARGB(88, 133, 160, 161), // Set icon color to white
            ),
          ),
        ),
      ),
